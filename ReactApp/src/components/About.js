...
let About = ()=>{
    ...
    let navigate = useNavigate(); //helps to create route table on the fly and intercepted by BrowserRouter

    function onGoToHomeClick(){
        navigate("/home");
    ...
    return(
        <div id="about" >  
            ...
            <button className={"form-control btn btn-primary col-md-1"} onClick={onGoToHomeClick} >
                Go To Home
            </button>
        </div>
    )
