...
import {RegisterActions} from './Register-slice'; // Ensure correct import of VaccineActions
...
export const addRegisterToDB = (newItem) => {
    ...
    return async (dispatch) => {
        try {
            ...
            dispatch(RegisterActions.addRegisterItem(register));
        } catch (error) {
...
export const handleGetAllRegisterByStatus = (status) => {
    ...
    return async (dispatch) => {
        try{
            ...
            dispatch(RegisterActions.getAllRegisterByStatus(RegisterByStatusObj));
        }catch (error){
