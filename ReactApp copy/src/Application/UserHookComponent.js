...
import { SaveUserToDB, SaveUserToDBUsingFetch } from "../../src/store/User/userAction";
...
let User = useSelector((store)=>store.user.user) //reads defined data in reducer 
...
return(
    <>
        <h1>User Login UserHook Page</h1>
